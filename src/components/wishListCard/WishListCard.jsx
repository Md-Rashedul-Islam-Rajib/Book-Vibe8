            ...
            <div className="border rounded-xl p-4">
                <div className="flex gap-6">
                    ...
                    <div className="flex flex-col gap-4 justify-center">
                        <div>
                            <h2 className="text2 text-2xl font-bold">{bookName}</h2>
                        </div>
                        <div>
                        <span className="text-[#131313CC] font-medium text1">By : {author}</span>
                        </div>
                        <div className="flex gap-6">
                            <div><p className="text1"> <span className="font-bold">Tags : </span> {tags.map((tag,idx)=><button className="mr-4 btn-sm rounded-lg bg-[#23BE0A0D] text-[#23BE0A] font-medium" key={idx}>#{tag}</button>)}</p></div>
                            <div className="flex gap-2 items-center text1">
